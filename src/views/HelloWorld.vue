<template>
  ...
  <v-row>
    <v-col cols="12" sm="7" md="8" lg="8" xl="8" xxl="8"><CardTest /></v-col>
    <v-col cols="12" sm="5" md="4" lg="4" xl="4" xxl="4"><CardTest /></v-col>
  </v-row>
  <v-row>
    <v-col cols="12">
...
export default {
  ...
  data() {
    return {
      ...
      slides: ["Max", "Maxky", "Udomsark", "Amnuaysookwong", "Age 27"],
